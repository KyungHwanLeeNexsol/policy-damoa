...
```json
{
  ...
  "template_updates_applied": [
    {
      "file": ".moai/config/config.yaml",
      "updates": ["Added: system.new_feature_flag", "Updated: version to 0.28.2"]
    },
    {
      "file": ".claude/agents/",
      "updates": ["Added: 3 new agent definitions", "Updated: 5 existing agents"]
    }
  ],
  "conflicts_resolved": [
    {
...
// .moai/config/template-history.json
{
  "template_optimization": {
    ...
    "template_version": "0.28.2",
    "customizations_preserved": ["language", "team_settings", "domains", "custom_agents"]
  },
  "version_history": [
    {
      "version": "0.28.2",
